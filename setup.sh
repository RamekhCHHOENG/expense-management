...
yes | npx shadcn-vue@latest add avatar
yes | npx shadcn-vue@latest add badge
yes | npx shadcn-vue@latest add button
yes | npx shadcn-vue@latest add card
yes | npx shadcn-vue@latest add collapsible
yes | npx shadcn-vue@latest add command
yes | npx shadcn-vue@latest add dialog
yes | npx shadcn-vue@latest add drawer
...
yes | npx shadcn-vue@latest add navigation-menu
...
yes | npx shadcn-vue@latest add sheet
...
yes | npx shadcn-vue@latest add search
yes | npx shadcn-vue@latest add checkbox
yes | npx shadcn-vue@latest add skeleton
yes | npx shadcn-vue@latest add toast
yes | npx shadcn-vue@latest add sonner
